function slider(id,pause,animationSpeed,obj) {
	...
	*/
    ...
    function initSlider(){
	    ...
	    // Create Skeleton
		var slider_html =  '<div id="slider"><div class="prev-slide"><img src="./assets/image/left.png" alt="..." width="40" height="40"></div><div class="next-slide"><img src="./assets/image/right-arrow.png" alt="..." width="40" height="40"></div><ul id="slides" class="slides"></ul></div>';
